...
class DP3(BasePolicy):
    ...
    def compute_loss(self, batch):
        ...
        if self.obs_as_global_cond:
            ...
            # print(this_nobs['point_cloud'].shape, this_nobs['robot0_eef_pos'].shape, this_nobs['robot0_eef_quat'].shape, this_nobs['robot0_gripper_qpos'].shape)
            # print(this_nobs['point_cloud'][0])
            # import pickle
            # print(this_nobs['point_cloud'].shape)
            # with open('debug_pointcloud.pkl', 'wb') as f:
            #     pickle.dump(this_nobs['point_cloud'].cpu(), f)
            # exit()
            nobs_features = self.obs_encoder(this_nobs)
